...
class PedidoWebItemSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'base_calc_icms', 'perc_icms', 
            'perc_antec_tributaria', 
            'perc_red_icms', 
            'modalidade_calculo_subst', 
            'base_calc_icms_sub', 
            'perc_mva_sub', 
            'perc_icms_sub', 
            'perc_reducao_icms_sub', 
            'base_calc_antecipacao_trib', 
            'perc_antecipacao_trib', 
            ...
            'base_calc_cofins', 
            'perc_fundo_pobreza', 
            'perc_trib_aproximado',
            'base_calc_import', 
            'perc_import', 
            'base_calc_issqn', 
            'perc_issqn', 
            'perc_desp_acessorias', 
            'perc_seguro', 
            'perc_frete', 
            'natureza_custos', 
            'centro_custo', 
...
class PedidoWebSerializer(serializers.ModelSerializer):
    items = PedidoWebItemSerializer(many=True)
